window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function instructionTextOf(nodeData) {
    ...
    function collectInstructions(snapshot) {
     ...
     */
    function pickInstruction(instructions, rects, foldTop, epsilon) {
